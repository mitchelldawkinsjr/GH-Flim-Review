    ...
    <div class=\"section\" style=\"margin-top:18px\">
      <details>
        ...
        <ul>
          ...
          <li><b>Add yards and chains</b>: fight through contact; Catch/Rush yardage = +0.5 per yard; Broken Tackle(s) +0.5/bt; First Downs +5.</li>
          <li><b>Dominate run game</b>: position + hand fit + run feet (Good Block +2, Pancake +10).</li>
          <li><b>Finish drives</b>: Touchdowns are +15; Extra Point Conversion +2; red-zone detail matters.</li>
          <li><b>Stay locked in</b>: next-play reset and positive body language (avoid Lack of Focus and Bad Body Language).</li>
        </ul>
        <div class=\"muted\">Key Play Points Rubric: Touchdown +15, Relentless Effort +5, Elite Route +7, Good Route +2, Catch/Rush yardage +0.5/yd, Broken Tackle(s) +0.5/bt, Good Block +2, Pancake +10, First Down +5, Spectacular Catch +10, Extra Point Conversion +2; Missed Assignment -10, Dropped Pass -15, Bad Route -2, Loaf (Laziness) -2, Not Full Speed -3, Whiffed -1, Holding 0, Lack of Focus -0.5, Bad Body Language -0.5.</div>
      </details>
    </div>
    <div class="section">
      <h2>Weeks</h2>
